...
//		===========
    ...
    /**
     * Enlem ve boylam verileri verilmiþ bir yer için hava kirliliði bilgilerini geri döner
    ...
    /**
     * Enlem ve boylam verileri verilmiþ bir yer için günlük hava tahmini bilgisini geri döner
     * @param lat   Enlem bilgisi
     * @param lon	Boylam bilgisi
     * @return
     */
    ...
    /**
     * Verilen bilgiler dahilinde 3er saatlik aralýklala yapýlmýþ 5 adet hava tahminini geri döner
    ...
    /**
     * Verilen bilgiler dahilinde bir ilçenin enlem ve boylam bilgilerine ulaþmak için kullanýlýr
     * @param ilce	Bir þehrin ilçesinin adý
     * @param il	þehir adý
     * @param ulke	IOS ülke kýsa kodlarý, Türkiye için TR
     * @return
